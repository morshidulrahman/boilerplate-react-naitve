        ...
        <SafeAreaWrapper className='bg-white flex-1'>
            <View>
                ...
                <ScrollView >
                    ...
                    <View style={tw`mt-4 border-b-2 border-b-[#2FC8B3] mx-5 py-6`}>
                        <View className="flex-row">
                            <Image source={require("./../../assets/Rectangle645.png")} style={tw`w-28 h-28 rounded-xl`} resizeMode="cover" />
                            <View style={tw`ml-5 flex-row justify-between items-center flex-1`}>
                                <View>
                    ...
                    <View style={tw`mt-4 border-b-2 border-b-[#2FC8B3] mx-5 py-6`}>
                        <View className="flex-row">
                            <Image source={require("./../../assets/Rectangle644.png")} style={tw`w-28 h-28 rounded-xl`} resizeMode="cover" />
                            <View style={tw`ml-5 flex-row justify-between items-center flex-1`}>
                                <View>
